          ...
          for (int index = 0; index < iconList.length; index++)
            InkWell(
              onTap: () {
                setState(() {
                  selectedIndex =
                      index; // Actualiza el índice del ícono seleccionado
                });
              },
              child: index ==
                      2 // Si es el ítem 3, agregue espacios adicionales a cada lado
                  ? Container(
                      ...
                      child: IconNavbarWidget(
                        ...
                        isSelected: index ==
                            selectedIndex, // Verifica si el ícono está seleccionado
                      ),
                    )
                  : SizedBox(
                      width: size.width * 0.2,
